(function ($, DataTable) {
    ...
    DataTable.ext.buttons.export = {
        ...
        text: function (dt) {
            return '<i class="fas fa-cloud-download-alt"></i> ' + dt.i18n('buttons.export', 'Export') + '&nbsp;<span class="caret"/>';
        },
    ...
    DataTable.ext.buttons.postCsvVisibleColumns = {
        ...
        text: function (dt) {
            return '<i class="fas fa-file-csv"></i> ' + dt.i18n('buttons.csv', 'CSV (only visible columns)');
        },
